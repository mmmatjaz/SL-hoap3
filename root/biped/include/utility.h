...
extern "C" {
  ...
  /* reads a data file in column format and maintains a .bin file */
  int
  read_file_bin(char *fname, int n_col, int n_in, int n_out, int *ind_in,
		int *ind_out, double ***, double ***, int *nrow);
