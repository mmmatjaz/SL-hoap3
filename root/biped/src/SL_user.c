...

{
  ...
  misc_sim_sensor[ORTH_X] = (v[1]-last_v[1])*(double)motor_servo_rate-G*rot[1][1][_Z_];
  misc_sim_sensor[ORTH_Y] = (v[2]-last_v[2])*(double)motor_servo_rate-G*rot[1][2][_Z_];
  misc_sim_sensor[ORTH_Z] = (v[3]-last_v[3])*(double)motor_servo_rate-G*rot[1][3][_Z_];
