...
c[49]=c[49] - qext[49] + vcross[1]*K[49][1] + vcross[2]*K[49][2] + vcross[3]*K[49][3];
c[50]=c[50] - qext[50] + vcross[1]*K[50][1] + vcross[2]*K[50][2] + vcross[3]*K[50][3];
c[51]=c[51] - qext[51] + vcross[1]*K[51][1] + vcross[2]*K[51][2] + vcross[3]*K[51][3];
c[52]=c[52] - qext[52] + vcross[1]*K[52][1] + vcross[2]*K[52][2] + vcross[3]*K[52][3];
c[53]=c[53] - qext[53] + vcross[1]*K[53][1] + vcross[2]*K[53][2] + vcross[3]*K[53][3];
...
uc[23]=state[35].u - c[23] - qext[23];
uc[24]=state[36].u - c[24] - qext[24];
uc[25]=-c[25] - qext[25];
uc[26]=state[37].u - c[26] - qext[26];
uc[27]=state[38].u - c[27] - qext[27];
uc[28]=-c[28] - qext[28];
uc[29]=-c[29] - qext[29];
