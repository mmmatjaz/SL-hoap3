...
state[25].uff=-state[25].uex + f6[6] + fext6[6];
state[26].uff=-state[26].uex + f7[6] + fext7[6];
state[17].uff=-state[17].uex + f11[6] + fext11[6];
state[18].uff=-state[18].uex + f12[6] + fext12[6];
state[19].uff=-state[19].uex + f13[6] + fext13[6];
state[20].uff=-state[20].uex + f14[6] + fext14[6];
state[27].uff=-state[27].uex + f15[6] + fext15[6];
state[28].uff=-state[28].uex + f16[6] + fext16[6];
state[22].uff=-state[22].uex + f20[6] + fext20[6];
state[24].uff=-state[24].uex + f22[6] + fext22[6];
...
qext[6]=-state[25].uex + fext6[6];
qext[7]=-state[26].uex + fext7[6];
qext[8]=0.;
qext[9]=0.;
qext[10]=0.;
qext[11]=-state[17].uex + fext11[6];
qext[12]=-state[18].uex + fext12[6];
qext[13]=-state[19].uex + fext13[6];
qext[14]=-state[20].uex + fext14[6];
qext[15]=-state[27].uex + fext15[6];
qext[16]=-state[28].uex + fext16[6];
qext[17]=0.;
qext[18]=0.;
qext[19]=0.;
qext[20]=-state[22].uex + fext20[6];
qext[21]=fext21[6];
qext[22]=-state[24].uex + fext22[6];
