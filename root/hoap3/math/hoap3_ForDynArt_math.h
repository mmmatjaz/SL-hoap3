...
state[17].thdd=(-(a1[5]*h10[3]) - a1[2]*h10[6] + u[10] - a1[4]*(h10[1]*S101[1][1] + h10[2]*S101[2][1]) - a1[6]*(h10[1]*S101[1][3] + h10[2]*S101[2][3]) - a1[1]*(h10[4]*S101[1][1] + ARMLINK1*h10[1]*S101[1][3] + h10[5]*S101[2][1] + ARMLINK1*h10[2]*S101[2][3]) - a1[3]*(-(ARMLINK1*h10[1]*S101[1][1]) + h10[4]*S101[1][3] - ARMLINK1*h10[2]*S101[2][1] + h10[5]*S101[2][3]))/d[10];
...
state[18].thdd=(a10[5]*h11[3] + a10[2]*h11[6] + u[11] - a10[4]*(h11[1]*S1110[1][1] + h11[2]*S1110[2][1]) - a10[1]*(h11[4]*S1110[1][1] + h11[5]*S1110[2][1]) - a10[6]*(h11[1]*S1110[1][3] + h11[2]*S1110[2][3]) - a10[3]*(h11[4]*S1110[1][3] + h11[5]*S1110[2][3]))/d[11];
...
state[21].thdd=(-(a0[5]*h15[3]) + u[15] + a0[4]*(h15[1]*S150[1][1] + h15[2]*S150[2][1]) + a0[1]*(h15[4]*S150[1][1] + h15[5]*S150[2][1]) + a0[6]*(h15[1]*S150[1][3] + h15[2]*S150[2][3]) + a0[2]*(-h15[6] - BODYLINK2*h15[1]*S150[1][3] - BODYLINK2*h15[2]*S150[2][3]) + a0[3]*(-(BODYLINK2*h15[3]) + h15[4]*S150[1][3] + h15[5]*S150[2][3]))/d[15];
...
state[1].thdd=(-(a15[5]*h16[3]) + u[16] - a15[4]*(h16[1]*S1615[1][1] + h16[2]*S1615[2][1]) - a15[6]*(h16[1]*S1615[1][3] + h16[2]*S1615[2][3]) - a15[1]*(-(LEGLINK1*h16[3]) + h16[4]*S1615[1][1] - WAISTLINK1*h16[1]*S1615[1][3] + h16[5]*S1615[2][1] - WAISTLINK1*h16[2]*S1615[2][3]) - a15[3]*(-(WAISTLINK2*h16[3]) + WAISTLINK1*h16[1]*S1615[1][1] + h16[4]*S1615[1][3] + WAISTLINK1*h16[2]*S1615[2][1] + h16[5]*S1615[2][3]) - a15[2]*(h16[6] + h16[1]*(LEGLINK1*S1615[1][1] + WAISTLINK2*S1615[1][3]) + h16[2]*(LEGLINK1*S1615[2][1] + WAISTLINK2*S1615[2][3])))/d[16];
...
state[11].thdd=(-(a15[5]*h27[3]) + u[27] - a15[4]*(h27[1]*S2715[1][1] + h27[2]*S2715[2][1]) - a15[6]*(h27[1]*S2715[1][3] + h27[2]*S2715[2][3]) - a15[1]*(LEGLINK1*h27[3] + h27[4]*S2715[1][1] - WAISTLINK1*h27[1]*S2715[1][3] + h27[5]*S2715[2][1] - WAISTLINK1*h27[2]*S2715[2][3]) - a15[3]*(-(WAISTLINK2*h27[3]) + WAISTLINK1*h27[1]*S2715[1][1] + h27[4]*S2715[1][3] + WAISTLINK1*h27[2]*S2715[2][1] + h27[5]*S2715[2][3]) - a15[2]*(h27[6] + h27[1]*(-(LEGLINK1*S2715[1][1]) + WAISTLINK2*S2715[1][3]) + h27[2]*(-(LEGLINK1*S2715[2][1]) + WAISTLINK2*S2715[2][3])))/d[27];
