...
hoap3_InvDynArtfunc46();

hoap3_InvDynArtfunc47();

hoap3_InvDynArtfunc48();

hoap3_InvDynArtfunc49();

hoap3_InvDynArtfunc50();

hoap3_InvDynArtfunc51();

hoap3_InvDynArtfunc52();

hoap3_InvDynArtfunc53();

hoap3_InvDynArtfunc54();

hoap3_InvDynArtfunc55();
...
state[9].uff=p7[6] + a7[1]*JA7[6][1] + a7[2]*JA7[6][2] + a7[3]*JA7[6][3] + a7[4]*JA7[6][4] + a7[5]*JA7[6][5] + a7[6]*JA7[6][6];
state[10].uff=-p8[6] - a8[1]*JA8[6][1] - a8[2]*JA8[6][2] - a8[3]*JA8[6][3] - a8[4]*JA8[6][4] - a8[5]*JA8[6][5] - a8[6]*JA8[6][6];
state[25].uff=p9[6] + a9[1]*JA9[6][1] + a9[2]*JA9[6][2] + a9[3]*JA9[6][3] + a9[4]*JA9[6][4] + a9[5]*JA9[6][5] + a9[6]*JA9[6][6];
state[26].uff=p12[6] + a12[1]*JA12[6][1] + a12[2]*JA12[6][2] + a12[3]*JA12[6][3] + a12[4]*JA12[6][4] + a12[5]*JA12[6][5];
state[17].uff=-p14[6] - a14[1]*JA14[6][1] - a14[2]*JA14[6][2] - a14[3]*JA14[6][3] - a14[4]*JA14[6][4] - a14[5]*JA14[6][5] - a14[6]*JA14[6][6];
state[18].uff=p15[6] + a15[1]*JA15[6][1] + a15[2]*JA15[6][2] + a15[3]*JA15[6][3] + a15[4]*JA15[6][4] + a15[5]*JA15[6][5] + a15[6]*JA15[6][6];
state[19].uff=p16[6] + a16[1]*JA16[6][1] + a16[2]*JA16[6][2] + a16[3]*JA16[6][3] + a16[4]*JA16[6][4] + a16[5]*JA16[6][5] + a16[6]*JA16[6][6];
state[20].uff=p17[6] + a17[1]*JA17[6][1] + a17[2]*JA17[6][2] + a17[3]*JA17[6][3] + a17[4]*JA17[6][4] + a17[5]*JA17[6][5] + a17[6]*JA17[6][6];
state[27].uff=p18[6] + a18[1]*JA18[6][1] + a18[2]*JA18[6][2] + a18[3]*JA18[6][3] + a18[4]*JA18[6][4] + a18[5]*JA18[6][5] + a18[6]*JA18[6][6];
state[28].uff=p21[6] + a21[1]*JA21[6][1] + a21[2]*JA21[6][2] + a21[3]*JA21[6][3] + a21[4]*JA21[6][4] + a21[5]*JA21[6][5];
