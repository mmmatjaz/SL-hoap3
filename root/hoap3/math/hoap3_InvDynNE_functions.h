...
a3[1]=state[13].thd*v3[2] + a0[1]*S30[1][1] + a0[3]*S30[1][3];
a3[2]=-(state[13].thd*v3[1]) + a0[1]*S30[2][1] + a0[3]*S30[2][3];
a3[3]=state[13].thdd - a0[2];
a3[4]=state[13].thd*v3[5] + a0[4]*S30[1][1] - BODYLINK2*a0[2]*S30[1][3] + a0[6]*S30[1][3];
a3[5]=-(state[13].thd*v3[4]) + a0[4]*S30[2][1] - BODYLINK2*a0[2]*S30[2][3] + a0[6]*S30[2][3];
a3[6]=-(BODYLINK2*a0[3]) - a0[5];

a4[1]=state[1].thd*v4[2] + a3[1]*S43[1][1] + a3[3]*S43[1][3];
a4[2]=-(state[1].thd*v4[1]) + a3[1]*S43[2][1] + a3[3]*S43[2][3];
a4[3]=state[1].thdd + a3[2];
a4[4]=state[1].thd*v4[5] + WAISTLINK1*a3[3]*S43[1][1] + a3[4]*S43[1][1] - WAISTLINK1*a3[1]*S43[1][3] + a3[6]*S43[1][3] + a3[2]*(LEGLINK1*S43[1][1] + WAISTLINK2*S43[1][3]);
a4[5]=-(state[1].thd*v4[4]) + WAISTLINK1*a3[3]*S43[2][1] + a3[4]*S43[2][1] - WAISTLINK1*a3[1]*S43[2][3] + a3[6]*S43[2][3] + a3[2]*(LEGLINK1*S43[2][1] + WAISTLINK2*S43[2][3]);
...
a15[1]=state[7].thd*v15[2] + a3[1]*S153[1][1] + a3[3]*S153[1][3];
a15[2]=-(state[7].thd*v15[1]) + a3[1]*S153[2][1] + a3[3]*S153[2][3];
a15[3]=state[7].thdd + a3[2];
a15[4]=state[7].thd*v15[5] + WAISTLINK1*a3[3]*S153[1][1] + a3[4]*S153[1][1] - WAISTLINK1*a3[1]*S153[1][3] + a3[6]*S153[1][3] + a3[2]*(-(LEGLINK1*S153[1][1]) + WAISTLINK2*S153[1][3]);
a15[5]=-(state[7].thd*v15[4]) + WAISTLINK1*a3[3]*S153[2][1] + a3[4]*S153[2][1] - WAISTLINK1*a3[1]*S153[2][3] + a3[6]*S153[2][3] + a3[2]*(-(LEGLINK1*S153[2][1]) + WAISTLINK2*S153[2][3]);
...
fnet3[1]=links[13].m*a3[4] - a3[3]*links[13].mcm[2] + a3[2]*links[13].mcm[3] - links[13].mcm[1]*Power(v3[2],2) - links[13].mcm[1]*Power(v3[3],2) + v3[1]*(links[13].mcm[2]*v3[2] + links[13].mcm[3]*v3[3]) - links[13].m*v3[3]*v3[5] + links[13].m*v3[2]*v3[6];
fnet3[2]=links[13].m*a3[5] + a3[3]*links[13].mcm[1] - a3[1]*links[13].mcm[3] - links[13].mcm[2]*Power(v3[1],2) - links[13].mcm[2]*Power(v3[3],2) + v3[2]*(links[13].mcm[1]*v3[1] + links[13].mcm[3]*v3[3]) + links[13].m*v3[3]*v3[4] - links[13].m*v3[1]*v3[6];
...
fnet3[4]=a3[6]*links[13].mcm[2] - a3[5]*links[13].mcm[3] + (-(links[13].mcm[2]*v3[2]) - links[13].mcm[3]*v3[3])*v3[4] + (links[13].mcm[1]*v3[3] + links[13].m*v3[5])*v3[6] + v3[5]*(links[13].mcm[1]*v3[2] - links[13].m*v3[6]) + a3[1]*links[13].inertia[1][1] + a3[2]*links[13].inertia[1][2] + a3[3]*links[13].inertia[1][3] + v3[1]*(links[13].mcm[2]*v3[5] + links[13].mcm[3]*v3[6] - v3[3]*links[13].inertia[1][2] + v3[2]*links[13].inertia[1][3]) + v3[2]*(-(links[13].mcm[1]*v3[5]) - v3[3]*links[13].inertia[2][2] + v3[2]*links[13].inertia[2][3]) + v3[3]*(-(links[13].mcm[1]*v3[6]) - v3[3]*links[13].inertia[2][3] + v3[2]*links[13].inertia[3][3]);
fnet3[5]=-(a3[6]*links[13].mcm[1]) + a3[4]*links[13].mcm[3] + (-(links[13].mcm[1]*v3[1]) - links[13].mcm[3]*v3[3])*v3[5] + (links[13].mcm[2]*v3[3] - links[13].m*v3[4])*v3[6] + v3[4]*(links[13].mcm[2]*v3[1] + links[13].m*v3[6]) + a3[1]*links[13].inertia[1][2] + v3[1]*(-(links[13].mcm[2]*v3[4]) + v3[3]*links[13].inertia[1][1] - v3[1]*links[13].inertia[1][3]) + a3[2]*links[13].inertia[2][2] + a3[3]*links[13].inertia[2][3] + v3[2]*(links[13].mcm[1]*v3[4] + links[13].mcm[3]*v3[6] + v3[3]*links[13].inertia[1][2] - v3[1]*links[13].inertia[2][3]) + v3[3]*(-(links[13].mcm[2]*v3[6]) + v3[3]*links[13].inertia[1][3] - v3[1]*links[13].inertia[3][3]);
fnet3[6]=a3[5]*links[13].mcm[1] - a3[4]*links[13].mcm[2] + (links[13].mcm[3]*v3[2] + links[13].m*v3[4])*v3[5] + v3[4]*(links[13].mcm[3]*v3[1] - links[13].m*v3[5]) + (-(links[13].mcm[1]*v3[1]) - links[13].mcm[2]*v3[2])*v3[6] + v3[1]*(-(links[13].mcm[3]*v3[4]) - v3[2]*links[13].inertia[1][1] + v3[1]*links[13].inertia[1][2]) + a3[1]*links[13].inertia[1][3] + v3[2]*(-(links[13].mcm[3]*v3[5]) - v3[2]*links[13].inertia[1][2] + v3[1]*links[13].inertia[2][2]) + a3[2]*links[13].inertia[2][3] + v3[3]*(links[13].mcm[1]*v3[4] + links[13].mcm[2]*v3[5] - v3[2]*links[13].inertia[1][3] + v3[1]*links[13].inertia[2][3]) + a3[3]*links[13].inertia[3][3];
...
fext0[1]=fex0[1] + fext3[1]*Si03[1][1] + fext3[2]*Si03[1][2];
fext0[2]=fex0[2] - fext3[3];
fext0[3]=fex0[3] + fext3[1]*Si03[3][1] + fext3[2]*Si03[3][2];
fext0[4]=fex0[4] + fext3[4]*Si03[1][1] + fext3[5]*Si03[1][2];
fext0[5]=fex0[5] - fext3[6] - BODYLINK2*fext3[1]*Si03[3][1] - BODYLINK2*fext3[2]*Si03[3][2];
fext0[6]=fex0[6] - BODYLINK2*fext3[3] + fext3[4]*Si03[3][1] + fext3[5]*Si03[3][2];
