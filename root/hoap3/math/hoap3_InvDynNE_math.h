...
state[15].uff=state[15].uex - f3[5] - fext3[5];
state[16].uff=-state[16].uex + f4[4] + fext4[4];
state[17].uff=-state[17].uex + f5[6] + fext5[6];
state[13].uff=-state[13].uex + f7[6] + fext7[6];
state[1].uff=-state[1].uex + f8[6] + fext8[6];
state[2].uff=-state[2].uex + f9[6] + fext9[6];
state[3].uff=-state[3].uex + f10[6] + fext10[6];
state[4].uff=-state[4].uex + f11[6] + fext11[6];
state[5].uff=-state[5].uex + f12[6] + fext12[6];
state[6].uff=-state[6].uex + f13[6] + fext13[6];
state[7].uff=-state[7].uex + f19[6] + fext19[6];
state[8].uff=-state[8].uex + f20[6] + fext20[6];
state[9].uff=-state[9].uex + f21[6] + fext21[6];
state[10].uff=-state[10].uex + f22[6] + fext22[6];
state[11].uff=-state[11].uex + f23[6] + fext23[6];
state[12].uff=-state[12].uex + f24[6] + fext24[6];

/* torques due to external forces */
qext[1]=0;
qext[2]=-state[14].uex + fext2[6];
qext[3]=state[15].uex - fext3[5];
qext[4]=-state[16].uex + fext4[4];
qext[5]=-state[17].uex + fext5[6];
qext[6]=0.;
qext[7]=-state[13].uex + fext7[6];
qext[8]=-state[1].uex + fext8[6];
qext[9]=-state[2].uex + fext9[6];
qext[10]=-state[3].uex + fext10[6];
qext[11]=-state[4].uex + fext11[6];
qext[12]=-state[5].uex + fext12[6];
qext[13]=-state[6].uex + fext13[6];
qext[14]=0.;
qext[15]=0.;
qext[16]=0.;
qext[17]=0.;
qext[18]=0.;
qext[19]=-state[7].uex + fext19[6];
qext[20]=-state[8].uex + fext20[6];
qext[21]=-state[9].uex + fext21[6];
qext[22]=-state[10].uex + fext22[6];
qext[23]=-state[11].uex + fext23[6];
qext[24]=-state[12].uex + fext24[6];
qext[25]=0.;
qext[26]=0.;
qext[27]=0.;
qext[28]=0.;
