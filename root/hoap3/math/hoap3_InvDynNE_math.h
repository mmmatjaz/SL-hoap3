...
state[13].uff=-state[13].uex + f2[6] + fext2[6];
state[1].uff=-state[1].uex + f3[6] + fext3[6];
state[2].uff=-state[2].uex + f4[6] + fext4[6];
state[3].uff=-state[3].uex + f5[6] + fext5[6];
state[4].uff=-state[4].uex + f6[6] + fext6[6];
state[5].uff=-state[5].uex + f7[6] + fext7[6];
state[6].uff=-state[6].uex + f8[6] + fext8[6];
state[7].uff=-state[7].uex + f14[6] + fext14[6];
state[8].uff=-state[8].uex + f15[6] + fext15[6];
state[9].uff=-state[9].uex + f16[6] + fext16[6];
state[10].uff=-state[10].uex + f17[6] + fext17[6];
state[11].uff=-state[11].uex + f18[6] + fext18[6];
state[12].uff=-state[12].uex + f19[6] + fext19[6];

/* torques due to external forces */
qext[1]=0.;
qext[2]=-state[13].uex + fext2[6];
qext[3]=-state[1].uex + fext3[6];
qext[4]=-state[2].uex + fext4[6];
qext[5]=-state[3].uex + fext5[6];
qext[6]=-state[4].uex + fext6[6];
qext[7]=-state[5].uex + fext7[6];
qext[8]=-state[6].uex + fext8[6];
qext[9]=0.;
qext[10]=0.;
qext[11]=0.;
qext[12]=0.;
qext[13]=0.;
qext[14]=-state[7].uex + fext14[6];
qext[15]=-state[8].uex + fext15[6];
qext[16]=-state[9].uex + fext16[6];
qext[17]=-state[10].uex + fext17[6];
