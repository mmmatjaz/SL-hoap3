...
fileID = fopen('LinkParametersSim.cf','w');
...
fileID = fopen('SensorOffset.cf','w');
...
for joint=1:28
    ...
    '\n%s\t% 5.2f\t% 5.2f\t% 5.2f\t% 5.2f\t% 5.2f\t% 5.2f',...
        ...
        jointUpperLimits(joint),    0.0, 0.0, 0.1, 0.0);
end
...
fileID = fopen('SensorCalibration.cf','w');
...
fileID = fopen('SensorFilter.cf','w');
